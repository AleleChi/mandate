    ...
    <div className="min-h-screen bg-[#FAF9F6] text-[#18181B] flex flex-col justify-between font-sans pb-12">
      ...
      <header className="w-full pt-4 pb-3 px-6 bg-white border-b border-[#EAE8E1]">
        <div className="max-w-[440px] mx-auto flex items-center justify-between">
          ...
          <div
            onClick={() => onNavigate('/')}
            className="font-serif-koinonia font-bold text-lg tracking-[0.2em] text-[#C59B27] uppercase cursor-pointer select-none"
          >
            Koinonia
          </div>
          <div className="w-6" />
      ...
      <main className="flex-1 max-w-[440px] w-full mx-auto px-6 pt-12 pb-8 flex flex-col justify-center">
        <div className="bg-white border border-[#EAE8E1] rounded-3xl p-8 shadow-sm text-center space-y-6">
          ...
          {status === 'check_email' && (
            <div className="space-y-6 py-4 animate-fade-in">
              ...
              <div className="space-y-2">
                ...
                {emailParam && (
                  <p className="text-xs text-gray-700 font-semibold bg-[#FAF9F6] border border-[#EAE8E1] rounded-xl py-1.5 px-3 inline-block mt-2">
                    Sent to: {emailParam}
                  </p>
                )}
              </div>
